...
#include "src/views/userviews/mainmenu.h"
...
QT_MOC_LITERAL(1, 9, 13), // "loginSelected"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16), // "registerSelected"
QT_MOC_LITERAL(4, 41, 14), // "onLoginClicked"
QT_MOC_LITERAL(5, 56, 17) // "onRegisterClicked"

    },
    "MainMenu\0loginSelected\0\0registerSelected\0"
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginSelected(); break;
        case 1: _t->registerSelected(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::loginSelected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::registerSelected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MainMenu::loginSelected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MainMenu::registerSelected()
{
