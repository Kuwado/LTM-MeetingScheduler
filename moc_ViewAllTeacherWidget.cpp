...
QT_MOC_LITERAL(3, 38, 26), // "std::pair<std::string,int>"
QT_MOC_LITERAL(4, 65, 7) // "teacher"

    },
    "ViewAllTeacherWidget\0teacherSelected\0"
    "\0std::pair<std::string,int>\0teacher"
};
...
void ViewAllTeacherWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->teacherSelected((*reinterpret_cast< const std::pair<std::string,int>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ViewAllTeacherWidget::*)(const std::pair<std::string,int> & );
...
// SIGNAL 0
void ViewAllTeacherWidget::teacherSelected(const std::pair<std::string,int> & _t1)
{
